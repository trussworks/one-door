...
export const additionalRequests = [
  ...
  {
    key: "lifecycle-received",
    title: "Coordinate bookings for shared laboratory equipment",
    problem:
      "Laboratory staff book shared instruments by emailing a common inbox. Two teams sometimes arrive for the same time slot, and staff cannot see who approved a booking. They need one schedule that shows availability and responsibility.",
    affectedPeople: "Laboratory staff and the instrument coordinators",
    acceptanceCriteria: [
      "Staff can see available times and request a booking",
      "Approved bookings for the same instrument cannot overlap",
      "Each booking identifies the responsible person and its approval status",
    ],
    requirements: [
      "A shared schedule for laboratory instruments",
      "Approval for instruments that require a trained operator",
      "Cancellation notices for affected staff",
    ],
    constraints: ["Use existing agency accounts", "No public booking access"],
    unknowns: ["Which instruments need an approval step?"],
    requesterActorKey: "tobias-vance",
    organizationKey: "environmental-quality",
    serviceOfferingKey: null,
    assetKeys: [],
  ...
  {
    key: "lifecycle-waiting",
    title: "Record odors reported near industrial sites",
    problem:
      "Residents report odors by phone, but inspectors cannot reliably connect a report to the later site visit. The office needs each complaint and its inspection findings in one record.",
    affectedPeople: "Environmental complaint staff and field inspectors",
    acceptanceCriteria: [
      "Each complaint links to its inspection findings",
      "Staff can find repeat complaints about the same site",
    ],
    requirements: [
      "Record the reported location and time",
      "Attach inspection findings to the original complaint",
    ],
    constraints: ["Do not publish residents’ contact details"],
    unknowns: [
      "Do inspectors need to record findings when there is no network connection?",
    ],
    requesterActorKey: "tobias-vance",
    organizationKey: "environmental-quality",
    serviceOfferingKey: "mobile-field-inspection",
  ...
  },
  {
    ...
    title: "Route grant amendments for review",
    problem:
      "Grant amendments move between program and finance staff by email. Staff lose track of which version is being considered and whose review comes next.",
    affectedPeople: "Grant program staff and finance reviewers",
    acceptanceCriteria: [
      "Staff can identify the current amendment and its next reviewer",
      "Every approval records the reviewer and date",
    ],
    requirements: [
      "One current amendment record",
      "Separate program and finance review steps",
      "A record of changes and approvals",
    ],
    constraints: ["Keep applicant bank details outside this workflow"],
    unknowns: [],
    requesterActorKey: "leila-morgan",
    organizationKey: "state-comptroller",
    serviceOfferingKey: "grants-program-administration",
  ...
  {
    key: "lifecycle-resolved",
    title: "Collect feedback after service appointments",
    problem:
      "The office has no consistent way to ask people about a completed service appointment. Staff need a short survey and a report that separates ratings from written comments.",
    affectedPeople: "Service staff and people completing appointments",
    acceptanceCriteria: [
      "A completed appointment can trigger one survey invitation",
      "Staff can report ratings and review comments separately",
    ],
    requirements: [
      "A five-point rating",
      "An optional written comment",
      "A report of completed responses",
    ],
    constraints: [
      "Survey participation is optional",
      "Do not include case details in the invitation",
    ],
    unknowns: [],
    requesterActorKey: "nadia-brant",
    organizationKey: "constituent-services",
