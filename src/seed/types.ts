...
export interface SeedData {
  ...
  requestContentRevisions: Array<typeof requestContentRevisions.$inferInsert>;
  clarificationRequests: Array<typeof clarificationRequests.$inferInsert>;
  deliveryHandoffs: Array<typeof deliveryHandoffs.$inferInsert>;
  requestResolutions: Array<typeof requestResolutions.$inferInsert>;
